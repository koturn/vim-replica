...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_replica#Vim#Buffer#ANSI#import() abort
  ...
  execute join(['function! vital#_replica#Vim#Buffer#ANSI#import() abort', printf("return map({'_vital_created': '', 'define_syntax': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
